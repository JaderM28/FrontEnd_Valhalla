!(function (e, t) {
  ...
  var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    He =
      "Enero_Febrero_Mayo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split(
        "_"
      );
  ...
  var je = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split(
    "_"
  );
